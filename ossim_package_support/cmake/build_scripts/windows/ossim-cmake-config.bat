...
set OSSIM_BUILD_DIR=C:\Dev\osgeo\vs2010x64
...
-DKAKADU_ROOT_SRC=%OSSIM_DEPENDENCIES%/kakadu/v6_4_1-00367C ^
-DKAKADU_LIBRARY=%DEPLIBDIR%/kdu_v64R.lib ^
-DKAKADU_AUX_LIBRARY=%DEPLIBDIR%/kdu_a64R.lib ^
...
-DOPENTHREADS_LIBRARY=%DEPLIBDIR%/OpenThreads.lib ^
