 ...
 * in decimal degrees from 0 to ?0.
 ...
 * in decimal degrees from 0 to ?80. (For overlays that overlap the meridian of 180 longitude, values can extend beyond that range.)
 * <west> (required) Specifies the longitude of the west edge of the bounding box,
 * in decimal degrees from 0 to ?80. (For overlays that overlap the meridian of 180 longitude,
 * values can extend beyond that range.)
 * <rotation> (optional) specifies a rotation of the overlay about its center,
 * in degrees. Values can be ?80. The default is 0 (north). Rotations are specified in a clockwise direction.
 */ 
