...
namespace ossimGui {
   ...
   public:
      ...
      void setWidget(ossimGui::ImageScrollWidget* widget){m_widget = widget;}
      void setupAndExecuteSyncing();
      Visitor& visitor(){return m_visitor;}
      const Visitor& visitor()const{return m_visitor;}
      ViewManipulator* viewManipulator(){return m_viewManip.get();}
      const ViewManipulator* viewManipulator()const{return m_viewManip.get();}
   public slots:
      void exportImage();
   ...
   protected:
      ...
      Visitor m_visitor;
      ossimGui::ImageScrollWidget* m_widget;
      ossimRefPtr<ViewManipulator> m_viewManip;
      ossim_uint32                 m_syncType;
      ossimDpt                     m_currentViewPoint;
   ...
   protected:
      ...
      ossimGui::ImageScrollWidget* m_imageScrollWidget;
