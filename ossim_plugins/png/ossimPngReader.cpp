...
//
//----------------------------------------------------------------------------
// $Id: ossimPngReader.cpp 19878 2011-07-28 16:27:26Z dburken $
...
RTTI_DEF1(ossimPngReader, "ossimPngReader", ossimImageHandler)
   ...
   static const char OSSIM_ID[] = "$Id: ossimPngReader.cpp 19878 2011-07-28 16:27:26Z dburken $";
#endif
...
void ossimPngReader::restart()
{
   ...
   if ( setjmp( png_jmpbuf(thePngPtr) ) )
   {
