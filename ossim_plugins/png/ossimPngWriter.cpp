...
//
//----------------------------------------------------------------------------
// $Id: ossimPngWriter.cpp 21531 2012-08-27 16:16:07Z dburken $
...
//---
// For the "ident" program which will find all exanded $Id: ossimPngWriter.cpp 21531 2012-08-27 16:16:07Z dburken $ macros and print
// them.
//---
#if OSSIM_ID_ENABLED
static const char OSSIM_ID[] = "$Id: ossimPngWriter.cpp 21531 2012-08-27 16:16:07Z dburken $";
#endif
...
bool ossimPngWriter::writeStream()
{
   ...
   if(theInputConnection->isMaster())
   {
      ...
      ossim_int32 alphaBand     = -1; // undefined
